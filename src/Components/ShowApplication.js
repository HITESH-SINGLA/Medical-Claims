...
function ShowApplication() {
  ...
  const getData2 = async () => {
    const res2 = await fetch("http://127.0.0.1:5000/get_medical_attendance", {
      method: "POST",
  ...
  const getData = async () => {
    const res = await fetch("http://127.0.0.1:5000/showApplicationId/" + id, {
      method: "POST",
  ...
  const getStatus = async () => {
    const res2 = await fetch(
      "http://127.0.0.1:5000/showApplicationIdStatus/" + id,
      {
        method: "POST",
        body: JSON.stringify({ user_data }),
        headers: { "Content-Type": "application/json" },
  ...
  const resubmit_application = async (e) => {
    ...
    if (
      ...
      const res4 = await fetch("http://127.0.0.1:5000/resubmitApplication", {
        method: "POST",
        body: JSON.stringify({
          ...new_obj,
      ...
      <Container>
        ...
        <Container>
          ...
          <Form>
            ...
            {rslt["isHold"] === "yes" && (
              <div>
                <h5>if you want to add more rows to Table:1 add here</h5>
                <form>
                  <input
                    type="text"
            ...
            {rslt["isHold"] === "yes" && (
              <div>
                <h4>
                  if you want to edit any of the above rows in Table:1, edit
                  here.
                </h4>
                <br />
                <form>
            ...
            {rslt["isHold"] === "yes" && (
              <div>
                <h5>if you want to add more rows to Table:2 add here</h5>
                <form>
                  <input
                    type="text"
            ...
            {rslt["isHold"] === "yes" && (
              <div>
                <h4>
                  if you want to edit any of the above rows in Table:2, edit
                  here.
                </h4>
                <br />
                <form>
